    ...
    <section className='w-screen h-auto flex items-center justify-center' data-scroll-section>
      <div className="flex flex-col w-full h-full p-20 justify-center items-start">
        ...
        <div className="flex flex-col w-full h-full relative gap-2">
          <div className="w-[55%] h-full bg-black rounded-2xl ml-[5vw] flex flex-row px-10 items-center py-4" data-scroll data-scroll-speed="2" data-scroll-direction="horizontal">
          ...
          <div className="w-[55%] h-full bg-black rounded-2xl ml-[15vw] flex flex-row px-10 items-center py-4" data-scroll data-scroll-speed="4" data-scroll-direction="horizontal">
            <div className="w-[17.5%] h-auto overflow-hidden rounded-full">
          ...
          <div className="w-[55%] h-full bg-black rounded-2xl ml-[25vw] flex flex-row px-10 items-center py-4" data-scroll data-scroll-speed="6" data-scroll-direction="horizontal">
            <div className="w-[17.5%] h-auto overflow-hidden rounded-full">
