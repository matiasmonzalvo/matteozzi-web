...
const Service = () => {
  return (
    <section className='w-screen h-screen flex flex-col items-center justify-center' data-scroll-section>
      <div className="flex flex-col justify-center items-center">
        <h1 className='text-[5vw] font-[800] m-0 p-0'>Nuestros Servicios</h1>
      </div>
      <div className="w-full h-auto px-20 pb-20 mt-10 flex flex-row justify-center items-center">
        <div className="w-full h-[95%] bg-teal-100 border-[1px] border-gray-800 rounded-2xl flex flex-col justify-center items-center py-16" data-scroll data-scroll-direction="horizontal" data-scroll-speed="2">
        ...
        <div className="w-full h-full bg-teal-100 border-[1px] border-gray-800 rounded-2xl z-20 relative flex flex-col justify-center items-center py-16" data-scroll>
          <div className="text-[3.5vw] p-[2vw] rounded-full bg-black text-white">
            <GiTruck />
          </div>
