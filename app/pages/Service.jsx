  ...
  return (
    <section className='w-screen h-screen flex items-center justify-center' data-scroll-section>
      <div className="w-full h-full p-20 flex flex-row justify-center items-center">
        <div className="w-full h-[95%] bg-zinc-100 border-[1px] border-gray-800 rounded-2xl flex flex-col justify-center items-center" data-scroll data-scroll-direction="horizontal" data-scroll-speed="2">
        ...
        <div className="w-full h-full bg-zinc-100 border-[1px] border-gray-800 rounded-2xl z-20 relative flex flex-col justify-center items-center" data-scroll>
          <div className="text-[3.5vw] p-[2vw] rounded-full bg-black text-white">
            <GiTruck />
          </div>
