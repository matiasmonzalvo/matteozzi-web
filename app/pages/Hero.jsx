...
const Hero = () => {
  return (
    <section className='w-screen h-screen flex items-center justify-center overflow-hidden' data-scroll-section>
        ...
        <div className='w-full h-auto flex flex-col lg:flex-row items-center justify-start relative px-5 lg:px-20  sm:flex-col'>
            ...
            <div className="lg:w-[42.75%] lg:h-full lg:absolute lg:right-20 z-[-1] md:relative md:w-[100%] md:h-auto mt-[-10%] lg:mt-0">
                <img className='lg:w-auto lg:h-full rounded-2xl border-[1px] border-gray-500 md:w-full md:h-auto' src="/hero.jpg" alt="" />
            </div>
        </div>
    </section>
  )
